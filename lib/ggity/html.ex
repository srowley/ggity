# Copied directly from the Plug.HTML module in the Plug library.

# Copyright (c) 2013 Plataformatec. Used under the terms of the
# applicable license - notice below.
